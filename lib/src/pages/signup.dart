...
import 'package:flutter_ecommerce_app/src/widgets/custom_shape.dart';
import 'package:flutter_ecommerce_app/src/widgets/customappbar.dart';
import 'package:flutter_ecommerce_app/src/widgets/responsive_ui.dart';
import 'package:flutter_ecommerce_app/src/widgets/textformfield.dart';
      ...
      children: <Widget>[
        ...
        Container(
          ...
          child: GestureDetector(
              ...
              child: Icon(Icons.add_a_photo, size: _large? 40: (_medium? 33: 31),color: LightColor.orange,)),
        ),
//        Positioned(
//          top: _height/8,
//          left: _width/1.75,
...
//        height: _height / 20,
        ...
        child: Text('ثبت نام', style: TextStyle(fontSize: _large? 18: (_medium? 16: 18)),),
      ),
    );
  }
